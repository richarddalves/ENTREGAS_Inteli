...
import GameScene2 from "./scene2.js";
...
class GameOverScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    // Adicionar esta linha para exibir a pontuação
    if (data && data.score) {
      this.add.text(300, 200, "Pontuação: " + data.score, { fontSize: "32px", fill: "#fff" });
    }
...
class WinScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    if (data && data.score) {
      this.add.text(300, 200, "Pontuação Final: " + data.score, { fontSize: "32px", fill: "#fff" });
    }
